...
function RegisterPage() {
    ...
    const handleCompermPassword = ()=>{
        setConfermPassword(!showComfermPassword)
    }
    ...
    <div className="flex  items-center min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1606660265514-358ebbadc80d?auto=format&fit=crop&w=1600&q=80')",
          }}
        ></div>
  ...
  <div className="relative">
    ...
    {/* Eye Icon (Right Side) */}
    {
        showPassword?   <span onClick={handlePasswor}  className="absolute inset-y-0 right-3 flex items-center cursor-pointer text-gray-500">
      ❌
    </span>:
    
    <span onClick={handlePasswor} className="absolute inset-y-0 right-3 flex items-center cursor-pointer text-gray-500">
      👁
    </span>
}
  </div>
          </div>
          {/* conparm Password Input */}
     <div className="mt-4">
  <label
    htmlFor="confirmPassword"
    className="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200"
  ...
  <div className="relative">
    ...
    {/* Eye Icon (Right Side) */}
    {
        showComfermPassword?   <span onClick={handleCompermPassword}  className="absolute inset-y-0 right-3 flex items-center cursor-pointer text-gray-500">
      ❌
    </span>:
    
    <span onClick={handleCompermPassword} className="absolute inset-y-0 right-3 flex items-center cursor-pointer text-gray-500">
      👁
    </span>
}
  </div>
